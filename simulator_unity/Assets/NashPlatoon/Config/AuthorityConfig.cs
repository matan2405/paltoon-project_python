...
public class AuthorityConfig : ScriptableObject {
    ...
    [Header("Long — FOLLOWING phase cap (same as Python LONG_AUTHORITY_LAMBDA_MAX_FOLLOWING)")]
    public float LongLambdaMaxFollowing = 5.0f;  // α(5)=1/6≈0.167 → human ≥17% tracking weight
