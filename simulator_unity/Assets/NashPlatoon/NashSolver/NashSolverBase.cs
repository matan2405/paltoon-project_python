...
//   LongLambdaLevels — 11 levels [0.1 … 50.0]  (λ_max reflects long emergency range)
//   LatLambdaLevels  — 7 levels [0.1 … 10.0]  (lateral authority saturates earlier)
...
namespace NashPlatoon
{
    public abstract class NashSolverBase : IDisposable
    {
        ...
        protected static readonly double[] LongLambdaLevels =
            { 0.1, 0.25, 0.5, 1.0, 2.0, 5.0, 10.0, 15.0, 30.0, 40.0, 50.0 };   // 11 levels
        protected static readonly double[] LatLambdaLevels =
            { 0.1, 0.25, 0.5, 1.0, 2.0, 5.0, 10.0 };          // 7 levels
