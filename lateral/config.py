...
NASH_R2 = 1000000.0     # Human's cost on its own control
...
AUTHORITY_K_STEEPNESS = 0.025       # Sigmoid slope (was 0.02 — increased for sharper sigmoid: human ~75% at rest vs 64%)
...
LANE_CHANGE_MIN_TIME = 6.0           # min seconds in LANE_CHANGE before LANE_KEEPING
LANE_CHANGE_Y_ERROR_FACTOR = 0.05    # |y_error| < 5% * lane_width to enter LANE_KEEPING (was 0.3 — too permissive, caused premature exit at τ≈0.61)
LANE_CHANGE_Y_DOT_THRESHOLD = 0.10   # |y_dot| < 0.10 m/s — vehicle must be nearly stopped laterally (was 0.15 — too permissive for aggressive settling)
